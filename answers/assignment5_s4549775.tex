...
\begin{enumerate}[a]
	...
	If Eve inserts a bogus packet, she cannot generate the digital signature. The receiving client hashed the message, decrypts the digital signature and compares the two. They do not match and the packet is dropped.
	\item %b
\end{enumerate}
